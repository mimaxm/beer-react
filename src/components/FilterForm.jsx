						...
						<div className="filter-form__block1">
							<div className="filter-form__group">
								...
								<input
									...
									step="1"
									onChange={(e) =>
										setFilterValue({ ...filterValue, abv_gt: e.target.value })
									}
								/>
								...
								<input
									...
									step="1"
									onChange={(e) =>
										setFilterValue({ ...filterValue, abv_lt: e.target.value })
									}
								/>
							</div>
							<div className="filter-form__group">
								...
								<input
									...
									step="50"
									onChange={(e) =>
										setFilterValue({ ...filterValue, ibu_gt: e.target.value })
									}
								/>
								...
								<input
									...
									step="50"
									onChange={(e) =>
										setFilterValue({ ...filterValue, ibu_lt: e.target.value })
									}
								/>
							</div>
							<div className="filter-form__group">
								...
								<input
									...
									step="10"
									onChange={(e) =>
										setFilterValue({ ...filterValue, ebc_gt: e.target.value })
									}
								/>
								...
								<input
									...
									step="10"
									onChange={(e) =>
										setFilterValue({ ...filterValue, ebc_lt: e.target.value })
									}
								/>
							</div>
							<div className="filter-form__group">
								...
								<input
									...
									onChange={(e) =>
										setFilterValue({
											...filterValue,
											brewed_after: moment(e.target.value).format("MM-YYYY"),
										})
									}
								/>
								...
								<input
									...
									onChange={(e) =>
										setFilterValue({
											...filterValue,
											brewed_before: moment(e.target.value).format("MM-YYYY"),
										})
									}
								/>
							</div>
						...
						<div className="filter-form__block2">
							<div className="filter-form__group">
								...
								<input
									...
									type="text"
									onChange={(e) =>
										setFilterValue({ ...filterValue, yeast: e.target.value })
									}
								/>
							</div>
							<div className="filter-form__group">
								...
								<input
									...
									type="text"
									onChange={(e) =>
										setFilterValue({ ...filterValue, hops: e.target.value })
									}
								/>
							</div>
							<div className="filter-form__group">
								...
								<input
									...
									type="text"
									onChange={(e) =>
										setFilterValue({ ...filterValue, malt: e.target.value })
									}
								/>
							</div>
							<div className="filter-form__group">
								...
								<input
									...
									type="text"
									onChange={(e) =>
										setFilterValue({ ...filterValue, food: e.target.value })
									}
								/>
							</div>
							<div className="filter-form__group">
								...
								<input
									...
									min="1"
									onChange={(e) =>
										setFilterValue({ ...filterValue, ids: e.target.value })
									}
								/>
							</div>
						</div>
